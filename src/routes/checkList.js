...
router.get('/:id/edit', async (req, res) => {
    try {
        ...
        res.status(500).render('pages/error', { error: 'Error ao exibir as edição de lista de tarefas.' })
    }
})
...
router.delete('/:id', async (req, res) => {
    try {
        ...
        res.status(500).render('pages/error', { error: 'Error ao deletar as listas de tarefas.' })
    }
})
